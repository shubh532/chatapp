        ...
        <div className='w-10/12 lg:w-2/5 md:w-3/5 p-6 shadow-lg shadow-gray-500 rounded-lg m-auto translate-y-24'>
            ...
            <form>
                ...
                <div className="flex justify-between ">
                    <button onClick={SignUpBtnHandler} className="text-white bg-blue-500 mr-2 duration-300 focus:bg-blue-700 hover:bg-blue-700 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">{show ? "SignUp" : "Login"}</button>
